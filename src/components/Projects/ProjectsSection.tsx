  ...
  return (
    <section id="projects" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        <RevealOnScroll>
          <h2 className="text-4xl font-bold mb-4 text-center font-handwritten">
            Featured Projects
          </h2>
        </RevealOnScroll>
        <RevealOnScroll delay={0.2}>
          <p className="text-gray-600 mb-12 text-center max-w-2xl mx-auto font-handwritten">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 h-full">
          {projects.map((project, index) => (
            <div key={project.title} className="h-full">
              <RevealOnScroll delay={0.2 * (index + 1)} direction="up" className="h-full">
                <ProjectCard {...project} />
              </RevealOnScroll>
            </div>
          ))}
