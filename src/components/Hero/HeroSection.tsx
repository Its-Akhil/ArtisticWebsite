...
export default function HeroSection() {
  return (
    <section id="home" className="relative min-h-screen py-16 md:py-24">
      <div className="absolute inset-0">
        <GridBackground />
      </div>
      <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center min-h-[calc(100vh-64px)]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 w-full">
          <div className="relative space-y-6 md:space-y-8">
            <RevealOnScroll direction="up" delay={0.2}>
              <h1 className="font-handwritten text-4xl md:text-5xl font-bold leading-tight">
                Showcase Your Coding Skills with CodeShowcase
              </h1>
            </RevealOnScroll>
            
            <RevealOnScroll direction="up" delay={0.4}>
              <p className="text-gray-600 text-base md:text-lg font-handwritten">
            ...
            <RevealOnScroll direction="up" delay={0.6}>
              <div className="flex items-center space-x-4">
                <button className="bg-black text-white px-4 md:px-6 py-2 md:py-3 rounded-lg hover:bg-gray-800 transition-colors flex items-center space-x-2 font-handwritten text-sm md:text-base">
